...
<div class="navbar-header">
  ...
  <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >Learn to Program </a>
</div>
...
<div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <!--     <li>
                ...
                <li>
                     <a href="<?php echo web_root; ?>admin/modules/lesson/index.php"><i class="fa fa-user fa-fw"></i> Lezioni </a>
                </li>
                 <li>
                     <a href="<?php echo web_root; ?>admin/modules/exercises/index.php"><i class="fa fa-user fa-fw"></i> Esami </a>
                </li>
                 <li>
