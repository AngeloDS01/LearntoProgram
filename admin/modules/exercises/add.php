                     ...
                     <form class="form-horizontal span6" action="controller.php?action=add" method="POST" style="margin-top: 20px;">
                        <div class="row">
                           <div class="col-lg-12">
                              <h1 class="page-header">Aggiungi una nuova domanda</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                         </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-8">
                          ...
                          <div class="col-md-8">
                           <button class="btn btn-primary btn-sm" name="save" type="submit" ><span class="fa fa-save fw-fa"></span>  Salva</button>
                           </div>
                        </div>
                      </div>
                      </form>
