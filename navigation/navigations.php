...
<title><?php echo $title;?> | Learn to Program</title>
...
<section id="title-header">
  <div class="title">
     <img class="logo" src="img/logo-piccolo.png">Learn to Program </img>

  </div>
</section>
<section id="navigation">
  <div id="mySidenav" class="sidenav">
    <a href="<?php echo web_root; ?>index.php?q=lesson" id="lesson">Lezioni <i class="fa fa-home"></i></a>
    <a href="<?php echo web_root; ?>index.php?q=exercises" id="exercise">Esami</a>
    <a href="<?php echo web_root; ?>index.php?q=download" id="download">Scarica</a>
    <a href="<?php echo web_root; ?>index.php?q=certificazioni" id="about">Certificato</a>
     <a href="logout.php" id="login">Esci</a>
  </div>
</section>
...
<footer  >
    <p align="left">&copy; Learn to Program</p>
</footer>
</section>
