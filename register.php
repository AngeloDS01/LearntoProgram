...
<section id="title-header">
  <div class="title">
     <img class="logo" src="img/logo-piccolo.png">Learn to Program
  </div>
</section>
                ...
                <div class="form-group">
                    <div class="col-md-9">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder=
                            "Inserire nome" type="text" value="" required>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-9">
                      ...
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="LNAME" name="LNAME" placeholder=
                            "Inserire Cognome" type="text" value=""  required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <div class="col-md-9">
                      <label class="col-md-4 control-label" for=
                      "PHONE">Cellulare</label>

                      <div class="col-md-8">
                         <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                            "Inserire numero" type="text" value="" required>
                      </div>
                    </div>
                  </div>
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color:  #0063BA; color:#fff;">
              <p align="center">&copy; Learn to Program</p>
     </footer>
 </section>
